...
public abstract class Move_Func_InterFace :MonoBehaviour{
	...
	protected const string 	JUMP_PATH	= "Triggers/Jump";
	...
	protected Vector2 		JUMP_MOVE			= new Vector2 (0f,7.5f);

	public abstract void rightMove();
	public abstract void leftMove();
	public abstract void startLeftMove ();
	public abstract void startRightMove ();
